...
export function EmiratesBanner() {
  return (
    <section className="relative overflow-hidden bg-[#0a1024] px-4 py-12 text-white sm:px-6 sm:py-16">
      ...
      <div className="relative mx-auto max-w-7xl rounded-2xl border border-white/[0.05] bg-white/[0.05] p-4 shadow-[0_18px_54px_rgba(0,0,0,0.16)] backdrop-blur sm:p-6 md:p-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="flex flex-wrap content-center justify-center gap-2 sm:gap-3">
            {emiratesBanner.emirates.map((emirate) => (
              <div
                className="flex min-h-14 w-full items-center justify-center gap-2.5 rounded-xl border border-white/[0.05] bg-white/[0.06] px-3 py-2.5 text-center text-sm font-black text-white shadow-[0_8px_20px_rgba(0,0,0,0.07)] sm:w-[calc(50%_-_0.375rem)]"
                key={emirate}
              >
                <span className="grid size-8 place-items-center rounded-full bg-[#00a86b]/18 text-[#7de8c5]">
