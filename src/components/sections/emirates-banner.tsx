...
export function EmiratesBanner() {
  return (
    <section className="relative overflow-hidden bg-[#0a1024] px-4 py-12 text-white sm:px-6 sm:py-16">
      ...
      <div className="relative mx-auto max-w-7xl rounded-2xl border border-white/12 bg-white/[0.06] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.22)] backdrop-blur sm:p-6 md:p-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="grid gap-2 sm:grid-cols-2 sm:gap-3">
            {emiratesBanner.emirates.map((emirate) => (
              <div
                className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.07] p-3 text-sm font-black text-white shadow-[0_12px_40px_rgba(0,0,0,0.12)] sm:p-4 sm:last:col-span-2 sm:last:mx-auto sm:last:min-w-[18rem]"
                key={emirate}
              >
